		...
		<nav class="mt-2">
			...
			<!-- Add icons to the links using the .nav-icon class with font-awesome or any other icon font library -->
				...
				<ul class="nav nav-treeview">
					...
					<li class="nav-item">
					<a href="add-health.php" class="nav-link active">
					<i class="fa fa-circle-o nav-icon"></i>
					<p>Add Health Log</p>
					</a>
					</li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Health Logs</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.html">Home</a></li>
              <li class="breadcrumb-item active">Add Health Logs</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
-->
		...
		<div class="form-group">
                  ...
                  <div class="form-group" id="reciever">
                    ...
                    <input type="text" class="form-control" id="exampleInputId" placeholder="Enter Patient Id">
                  </div>-->
		<div class="form-group" id="reciever">
                    <label for="exampleInputEmail1">Illness Nature</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Illness Nature">
                  </div>
		<div class="form-group" id="reciever">
                    <label for="exampleInputEmail1">Symptoms</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Symptoms">
                  </div>
		<div class="form-group" id="reciever">
                    <label for="exampleInputEmail1">Days</label>
                    <input type="numbers" class="form-control" id="exampleInputEmail1" placeholder="Enter Days">
                  </div>
		<div class="form-group" id="reciever">
                    <label for="exampleInputEmail1">Treatment Given</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Treatment">
                  </div>
		<div class="form-group" id="reciever">
                    <label for="exampleInputPin1">Action Type</label>
                    <input type="text" class="form-control" id="exampleInputPin1" placeholder="Enter Action Type">
                  </div>
