...
<head>
		...
		<title>Health Ring | Patient Dashboard</title>
...
<div class="info">
		...
		<a href="profile.php" class="d-block"><?php if (isset($_COOKIE['surname']))  echo $_COOKIE['surname']; ?></a>
</div>
</div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">My Activities  Report</h5>
                   </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <span class="description-text">PATIENT ACTIVITIES</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header"></h5>
                      <span class="description-text">HEALTH ACTIVITIES</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header"></h5>
                      <span class="description-text">PAYMENT ACTIVITIES</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-3 col-6">
                    <div class="description-block">
                      ...
                      <h5 class="description-header"></h5>
                      <span class="description-text">TRACKED ACTIVITIES</span>
                    </div>
                    <!-- /.description-block -->
                  </div>
                </div>
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">MY HEALTH PROGRESS<a href="health.php"><span class="badge badge-primary">View All</span></a></h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
					  ...
					  <th>Health Progress</th>
                      </tr>
                    </thead>
                    <tbody>
						<?php
						$sql = "SELECT * FROM healthlog WHERE sid='$sid'";
						...
						if ($result->num_rows > 0) {
							...
							while($row = $result->fetch_assoc()) { 
								echo "<tr>";
								echo "<td><a href='undetermined'>". $row['hid'] ."</a></td>";
								echo "<td>".$row['administered_by']."</td>";
								echo "<td>".$row['illness_nature']."</td>";
								echo "<td><span class='badge badge-success'>".$row['progress']."</span></td>";
								echo "</tr>";
							}
						}
						else 
